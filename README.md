...
✅ **[Lab1-将 XSS 映射到 HTML 上下文中，且没有编码](./XSS/Lab1-将 XSS 映射到 HTML 上下文中，且没有编码)**  
✅ **[Lab2-将XSS存储为锚属性，并用HTML编码双引号href](./XSS/Lab2-将XSS存储为锚属性，并用HTML编码双引号href)**  
✅ **[Lab3-利用XSS绕过CSRF防御](./XSS/Lab3-利用XSS绕过CSRF防御)**  
✅ **[Lab4-将XSS映射到HTML上下文中，大部分标签和属性被屏蔽](./XSS/Lab4-将XSS映射到HTML上下文中，大部分标签和属性被屏蔽)**  
